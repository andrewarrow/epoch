{{ define "projects" }}
  div id=p1 hidden flex space-x-6 items-center
  div id=p2 hidden flex space-x-6 items-center
  div id=p3 hidden flex space-x-6 items-center
  div id=p4 hidden flex space-x-6 items-center
  div id=p5 hidden flex space-x-6 items-center
  div id=p6 hidden flex space-x-6 items-center
  div id=p7 hidden flex space-x-6 items-center
  div id=p8 hidden flex space-x-6 items-center
  div id=p9 hidden flex space-x-6 items-center
